...
export default function EmployeeTablePage() {
  ...
  const filteredEmployees = useMemo(() => { 
    ...
    if (filters.employeeType) { 
      ...
      filtered = filtered.filter(emp => { 
          const empType = emp.professionalInfo?.employeeType?.toLowerCase(); 
         
          return isRemote ? empType?.includes('remote') : !empType?.includes('remote'); 
      }); 
    } 
    return filtered; 
